...
`@raidiant/notifai` 0.2.0 and `@raidiant/notifai-protocol` 0.2.0; their
...
from the immutable public tag `v0.2.0`; the underlying installer source is
`Raidiant-io/notifai#v0.2.0` (`#` selects a Git ref). For unattended use,
