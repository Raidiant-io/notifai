...
`@raidiant/notifai` <!--x-release-please-start-notifai-->9.3.0<!--x-release-please-end--> and `@raidiant/notifai-protocol` <!--x-release-please-start-protocol-->5.0.2<!--x-release-please-end-->; their
...
from the immutable public tag `v<!--x-release-please-start-notifai-->9.3.0<!--x-release-please-end-->`; the underlying installer source is
`Raidiant-io/notifai#v<!--x-release-please-start-notifai-->9.3.0<!--x-release-please-end-->` (`#` selects a Git ref). For unattended use,
